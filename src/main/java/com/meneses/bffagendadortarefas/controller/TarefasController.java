...
import com.meneses.bffagendadortarefas.business.TarefasService;
...
public class TarefasController {
    ...
    @ApiResponse(responseCode = "500", description = "Erro de servidor")
    public ResponseEntity<List<TarefasDTOResponse>> buscaListaTarefasPeriodo(
    ...
    @DeleteMapping
    @Operation(summary = "Deleta Tarefas id", description = "Deleta tarefas cadastradas por id")
    ...
    public ResponseEntity<TarefasDTOResponse> alteraStatusNotificacao(@RequestParam("status") StatusNotificacaoEnum status,
                                                                      ...
                                                                      @RequestHeader(name = "Authorization", required = false) String token) {
        return ResponseEntity.ok(tarefasService.aletaStatus(status, id, token));
    }
