...
public class CronService {
    ...
    public void buscaTarefasProximaHora() {
        ...
        LocalDateTime horaFuturaMaisCinco = LocalDateTime.now().plusHours(1).minusMinutes(5);
        ...
        listaTarefas.forEach(tarefa -> {
            ...
            tarefasService.aletaStatus(StatusNotificacaoEnum.NOTIFICADO, tarefa.getId(), token);
        });
